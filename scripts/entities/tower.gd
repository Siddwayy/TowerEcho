...
const TURRET_DESTRUCTION_PARTICLE = preload("res://scenes/effects/destruction_effect.tscn")
const TURRET_DESTRUCTION_SOUND = preload("res://scenes/effects/tower_explosion_sound.tscn")
