...
const EnemyBulletScene: PackedScene = preload("res://scenes/entities/enemy_bullet.tscn")
...
const DestructionParticleEffect = preload("res://scenes/effects/destruction_effect.tscn")
const ENEMY_DESTRUCTION_SOUND = preload("res://scenes/effects/enemy_explosion_sound.tscn")
const DamageNumberScene = preload("res://scenes/effects/damage_number_enemy.tscn")
