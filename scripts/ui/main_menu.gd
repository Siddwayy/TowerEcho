...
const SOUND_ON_ICON: Texture2D = preload("res://assets/sprites/ui/buttons/audio_square_button.png")
const SOUND_OFF_ICON: Texture2D = preload("res://assets/sprites/ui/buttons/audio_col_square_button.png")

var _is_changing_scene: bool = false
var _is_music_playing: bool = true

const MAIN_LEVEL_SCENE_PATH = "res://scenes/levels/main_level.tscn" # Your game level path
